...
const DETAIL_ICONS = [
  ...
  <svg key="1" width="18" height="18" viewBox="0 0 24 24" fill="none" style={{ display: "block" }}><path d="M20 21V19C20 17.9391 19.5786 16.9217 18.8284 16.1716C18.0783 15.4214 17.0609 15 16 15H8C6.93913 15 5.92172 15.4214 5.17157 16.1716C4.42143 16.9217 4 17.9391 4 19V21M12 11C14.2091 11 16 9.20914 16 7C16 4.79086 14.2091 3 12 3C9.79086 3 8 4.79086 8 7C8 9.20914 9.79086 11 12 11Z" stroke="var(--cta)" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/></svg>,
                ...
                {active.length === 1 ? (() => {
                  ...
                  return (
                    <div style={{ background: "linear-gradient(135deg, #FFF6F2 0%, #F5FBFF 100%)", borderRadius: 20, padding: isMobile ? 20 : 32, display: "grid", gridTemplateColumns: !isMobile ? "1fr 220px" : "1fr", gridTemplateRows: "auto auto", columnGap: 32, rowGap: 24 }}>
                      ...
                      <div style={{ gridColumn: !isMobile ? "1 / 3" : 1, gridRow: 2, display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr 1fr", gap: 10 }}>
                        {s.details.map((d, i) => (
