...
const STANDORTE: Standort[] = [
  {
    ...
    bundesland: "Wien",
    stadt: "Wien",
    name: "Beratungszentrum Wien Mitte",
    adresse: "Landstraßer Hauptstraße 1, 1030 Wien",
    telefon: "+43 1 123 45 67",
    zeiten: "Mo–Fr · 9:00–18:00",
    info: "Barrierefrei zugänglich. Parkplätze vorhanden. U3 Erdberg (5 min).",
    online: true,
    mapsUrl: "https://maps.google.com/?q=Landstraßer+Hauptstraße+1+Wien",
  },
  {
    id: "wien-2",
    bundesland: "Wien",
    stadt: "Wien",
    name: "Beratungsstelle Wien Mariahilf",
    adresse: "Mariahilfer Straße 45, 1060 Wien",
    telefon: "+43 1 123 45 68",
    zeiten: "Mo–Sa · 8:00–20:00",
    info: "Zentrale Lage. U3 Neubaugasse (2 min). Abendtermine möglich.",
    online: true,
    mapsUrl: "https://maps.google.com/?q=Mariahilfer+Straße+45+Wien",
  },
  {
    id: "graz-1",
    bundesland: "Steiermark",
    stadt: "Graz",
    name: "Beratungsstelle Graz Zentrum",
    adresse: "Herrengasse 3, 8010 Graz",
    telefon: "+43 316 234 56 78",
    zeiten: "Mo–Fr · 9:00–17:00",
    info: "Historisches Stadtzentrum. Tram Hauptplatz (3 min). Barrierefrei.",
    online: true,
    mapsUrl: "https://maps.google.com/?q=Herrengasse+3+Graz",
  },
  {
    id: "linz-1",
    bundesland: "Oberösterreich",
    stadt: "Linz",
    name: "Beratungsstelle Linz Hauptplatz",
    adresse: "Hauptplatz 8, 4020 Linz",
    telefon: "+43 732 345 67 89",
    zeiten: "Mo–Fr · 9:00–17:00",
    info: "Direkt am Hauptplatz. Tram Hauptplatz (1 min). Aufzug vorhanden.",
    online: false,
    mapsUrl: "https://maps.google.com/?q=Hauptplatz+8+Linz",
  },
  {
    id: "salzburg-1",
    bundesland: "Salzburg",
    stadt: "Salzburg",
    name: "Beratungsstelle Salzburg Altstadt",
    adresse: "Getreidegasse 18, 5020 Salzburg",
    telefon: "+43 662 456 78 90",
    zeiten: "Mo–Fr · 9:00–17:00",
    info: "UNESCO-Welterbe Altstadt. Bus Rathaus (5 min).",
    online: true,
    mapsUrl: "https://maps.google.com/?q=Getreidegasse+18+Salzburg",
  },
  {
    id: "innsbruck-1",
    bundesland: "Tirol",
    ...
    telefon: "+43 512 567 89 01",
    zeiten: "Mo–Fr · 9:00–17:00",
    info: "Zentrale Lage. Tram Landhausplatz (3 min). Barrierefrei.",
    online: true,
    mapsUrl: "https://maps.google.com/?q=Maria-Theresien-Straße+12+Innsbruck",
  },
];
