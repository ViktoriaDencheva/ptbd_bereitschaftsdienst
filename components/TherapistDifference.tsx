    ...
    <section style={{ background: "var(--blue-ultra-light)" }}>
      ...
      <div className="td-mobile" style={{ display: "none", padding: "32px 16px" }}>
        ...
        <div key={active} style={{ background: "linear-gradient(135deg, var(--red-bg) 0%, var(--blue-ultra-light) 100%)", borderRadius: 20, padding: 20, display: "flex", flexDirection: "column", gap: 16, animation: "tdFadeIn 0.3s ease" }}>
          ...
          {/* CTA */}
          <Link href="/unterschied" style={{ width: "100%", background: "var(--cta)", color: "white", border: "none", borderRadius: 9999, height: 48, fontFamily: "'Poppins', sans-serif", fontWeight: 500, fontSize: 15, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 8, marginTop: 4, textDecoration: "none" }}>
            {TD.cta}
